...
export var Swiper = (function () {
                ...
                (x = (function () {
                    ...
                    const e = M(),
                        ...
                        i =
                            ...
                            !s.includes('chrome') &&
                            !s.includes('android'),
                        r = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(
                            t,
                        );
                    return {
                        isSafari: i,
    ...
    function R(e) {
        ...
        if (u > n.longSwipesMs) {
            ...
            (a.target === i.navigation.nextEl ||
                a.target === i.navigation.prevEl)
                ? a.target === i.navigation.nextEl
                    ? i.slideTo(f + y)
                    : i.slideTo(f)
                : ('next' === i.swipeDirection &&
                      i.slideTo(null !== v ? v : f + y),
    ...
    function _(e) {
        ...
        if (
            t.params.threshold &&
            Math.sqrt(m ** 2 + h ** 2) < t.params.threshold
        )
            return;
                      ...
                      t.loopFix({
                          ...
                          activeSlideIndex:
                              ...
                              ('auto' === r.slidesPerView
                                  ...
                                  : Math.ceil(
                                        parseFloat(String(r.slidesPerView)),
                                    )),
                      }),
    ...
    var F = {
        ...
        loopFix: function (e = {}) {
            ...
            const x = g.slidesPerGroupAuto ? S : g.slidesPerGroup,
                ...
                M =
                    p.slidesGrid.length > 1
                        ? (p.slidesGrid[p.slidesGrid.length - 1] -
                              p.slidesGrid[0]) /
                          (p.slidesGrid.length - 1)
                        : p.size,
                C = M > 0 ? T(w) / M : 0,
            ...
            let L = E
                ? Math.max(
                      x,
                      (v ? Math.ceil(S / 2) : 0) + Math.ceil(Math.max(C, P)),
                  )
                : x;
            (L % x !== 0 && (L += x - (L % x)),
            ...
            u.length < S + L ||
            ('cards' === p.params.effect && u.length < S + 2 * L)
                ? c(
                ...
                Array.isArray(Y)
                    ...
                    : Y instanceof p.constructor &&
                      ...
                      Y.loopFix({
                          ...e,
                          slideTo:
                              Y.params.slidesPerView === g.slidesPerView && s,
                      });
            }
        ...
        slideTo: function (e = 0, t, s = !0, i, r) {
            ...
            if (
                ...
                return (
                    ...
                    'reset' !== w &&
                        (a.transitionStart(s, w), a.transitionEnd(s, w)),
                    !1
                );
            if (l.cssMode) {
            ...
            if (r.params.loop)
                if (r.virtual && r.params.virtual?.enabled)
                    ...
                    'auto' === r.params.slidesPerView
                        ...
                        : ((c = Math.ceil(
                              parseFloat(String(r.params.slidesPerView)),
                          )),
                          d && c % 2 == 0 && (c += 1));
                    let p = t - e < c;
                    if (
    ...
    var J = {
        ...
        updateSlides: function () {
            ...
            for (let i = 0; i < u; i += 1) {
                ...
                if (
                    ...
                    if (o && 'auto' === s.slidesPerView)
                        ...
                        ((I =
                            (x - (s.slidesPerView - 1) * T) / s.slidesPerView),
                            s.roundLengths && (I = Math.floor(I)),
                            r &&
                                (r.style[e.getDirectionLabel('width')] =
                                    `${I}px`));
            ...
            if (
                ...
                const t =
                        'auto' !== s.slidesPerView && s.slidesPerView % 1 != 0,
                    i =
                        s.snapToSlideEdge &&
                        !s.loop &&
                ...
                for (let t = 0; t < h.length; t += 1) {
                    ...
                    (s.roundLengths && (n = Math.floor(n)),
                        i
                            ? t <= r && a.push(n)
                            : h[t] <= e.virtualSize - x && a.push(n));
                }
                ((h = a),
                    Math.floor(e.virtualSize - x) -
            ...
            if (o && s.loop) {
                const t = g[0] + T,
                    i =
                        (e.virtual.slidesBefore ?? 0) +
                        (e.virtual.slidesAfter ?? 0);
        ...
        init(e) {
            ...
            if (
                ...
                t.params.loop && t.virtual && t.params.virtual?.enabled
                    ? t.slideTo(
                          (t.params.initialSlide ?? 0) +
                              (t.virtual.slidesBefore ?? 0),
                          0,
    ...
    function pe(e, t) {
        ...
        let n = r;
        i.loop &&
            ((n -= s.loopedSlides ?? 0), s.loopDestroy(), s.recalcSlides());
    ...
    const ye = [
        ({ swiper: e, extendParams: t, on: s, emit: i }) => {
            ...
            function c(t, s, r) {
                ...
                let M, C;
                l
                    ? ((M = Math.floor(x / 2) + T + h),
                      (C = Math.floor(x / 2) + T + m))
                    : ((M = x + (T - 1) + h), (C = (p ? x : T) + m));
                let P = E - C,
                    L = E + M;
                        ...
                        e.slidesGrid !== b &&
                            ...
                            e.slides.forEach((t) => {
                                t.style.setProperty(
                                    S,
                                    I -
                                        Math.abs(e.cssOverflowAdjustment()) +
                                        'px',
                                );
                            }),
                        e.updateProgress(),
                    ...
                    removeSlide: function (t) {
                        ...
                        if (Array.isArray(t))
                            for (let r = t.length - 1; r >= 0; r -= 1)
                                (n().cache &&
                                    (delete e.virtual.cache[t[r]], i(t[r])),
        ...
        ({ swiper: e, extendParams: t, on: s, emit: i }) => {
            ...
            function a(t) {
                ...
                const { rtlTranslate: s } = e,
                    a =
                        'originalEvent' in t && t.originalEvent
                            ? t.originalEvent
                            : t,
                ...
                if (l.onlyInViewport && (d || c || p || m || h || g)) {
                    let t = !1;
                    if (
                        f(e.el, `.${e.params.slideClass}, swiper-slide`)
                            .length > 0 &&
        ...
        ({ swiper: e, extendParams: i, on: r, emit: a }) => {
            ...
            function f(i) {
                let r =
                        'originalEvent' in i && i.originalEvent
                            ? i.originalEvent
                            : i,
                    o = !0;
        ...
        ({ swiper: e, extendParams: t, on: s, emit: i }) => {
            ...
            function a(t) {
                ...
                return t &&
                    'string' == typeof t &&
                    e.isElement &&
                    ((s = e.el.querySelector(t) || e.hostEl.querySelector(t)),
                    s)
                    ? s
                    : (t &&
                          ('string' == typeof t &&
            ...
            function c() {
                ...
                (n.forEach((e) => c(e, 'next')),
                    l.forEach((e) => c(e, 'prev')));
            }
            function p() {
                const t = r(),
                ...
                (a.forEach((e) => l(e, 'next')),
                    n.forEach((e) => l(e, 'prev')));
            }
            (t({
                navigation: {
                    nextEl: null,
                ...
                s('click', (t, s) => {
                    ...
                    if (e.isElement && !p) {
                        ...
                        e.length &&
                            (p = e.find((e) => o.includes(e) || d.includes(e)));
                    }
                    if (a.hideOnClick && !p) {
                        if (
                            e.pagination &&
                        ...
                        (o.length
                            ...
                            : d.length &&
                              (t = d[0].classList.contains(a.hiddenClass)),
                            i(!0 === t ? 'navigationShow' : 'navigationHide'),
                            [...o, ...d]
                                .filter((e) => !!e)
                                .forEach((e) =>
                                    e.classList.toggle(a.hiddenClass),
                                ));
                    }
                }));
            const u = () => {
                const t = r();
                (e.el.classList.add(...t.navigationDisabledClass.split(' ')),
                    p());
            };
            Object.assign(e.navigation, {
                enable: () => {
                    ...
                    (e.el.classList.remove(
                        ...t.navigationDisabledClass.split(' '),
                    ),
                        c(),
                        l());
                },
                        ...
                        ('custom' !== t.type && y(s, a || ''),
                            'bullets' === t.type &&
                                e.pagination.bullets.push(
                                    ...Array.from(
                                        s.querySelectorAll(le(t.bulletClass)),
                                    ),
                                ));
                    }),
                ...
                s('click', (t, s) => {
                    ...
                    if (
                        ...
                        (i(!0 === t ? 'paginationShow' : 'paginationHide'),
                            a.forEach((e) =>
                                e.classList.toggle(n.hiddenClass),
                            ));
                    }
                }));
            const b = () => {
                ...
                if (s) {
                    w(s).forEach((e) =>
                        e.classList.add(t.paginationDisabledClass),
                    );
                }
                g();
            };
        ...
        ({ swiper: s, extendParams: i, on: r, emit: a }) => {
            ...
            function v() {
                ...
                ((i.style.width = ''),
                    ...
                    s.params.watchOverflow &&
                        s.enabled &&
                        t.el.classList[s.isLocked ? 'add' : 'remove'](
                            e.lockClass,
                        ));
            }
            function b(e) {
            ...
            function y(e) {
                ...
                const n =
                    s.minTranslate() +
                    (s.maxTranslate() - s.minTranslate()) * a;
                (s.updateProgress(n),
                    s.setTranslate(n),
                    s.updateActiveIndex(),
            ...
            function M() {
                ...
                if (
                    ...
                    a || (a = r.el);
                else if (((a = document.querySelectorAll(r.el)), !a.length))
                    return;
                ...
                const n = a;
                n.classList.add(
                    s.isHorizontal() ? r.horizontalClass : r.verticalClass,
                );
                let l = null;
                (n &&
                    ...
                    n &&
                        n.classList[s.enabled ? 'remove' : 'add'](
                            ...e(r.lockClass),
                        ));
            }
            function C() {
            ...
            (i({
                ...
                r('enable disable', () => {
                    ...
                    t &&
                        t.classList[s.enabled ? 'remove' : 'add'](
                            ...e(f().lockClass),
                        );
                }),
                r('destroy', () => {
        ...
        ({ swiper: e, extendParams: t, on: s, emit: r }) => {
            ...
            function x(t) {
                ...
                return (
                    !!i &&
                    (!!i.matches(s) ||
                        e.slides.filter((e) => e.contains(i)).length > 0)
                );
            }
            function T(t) {
            ...
            function M(t) {
                if (('mouse' === t.pointerType && h.splice(0, h.length), !x(t)))
                    return;
                const s = a();
                if (((p = !1), (m = !1), h.push(t), !(h.length < 2))) {
                    if (((p = !0), (g.scaleStart = E()), !g.slideEl)) {
                        ...
                        let r =
                            g.slideEl?.querySelector(`.${s.containerClass}`) ??
                            null;
                        if (
                            (r &&
                                (r =
            ...
            function C(t) {
                ...
                (r >= 0 && (h[r] = t),
                    h.length < 2 ||
                        ...
                        g.imageEl &&
                            ((i.scale =
                                (g.scaleMove / (g.scaleStart ?? 1)) * n),
                            i.scale > g.maxRatio &&
                                (i.scale =
                                    g.maxRatio -
                                    1 +
                                    (i.scale - g.maxRatio + 1) ** 0.5),
                            i.scale < s.minRatio &&
                                (i.scale =
                                    s.minRatio +
                                    1 -
                ...
                (r >= 0 && h.splice(r, 1),
                    p &&
                        ...
                        g.imageEl &&
                            ...
                            (l = !1),
                            i.scale > 1 && g.slideEl
                                ? g.slideEl.classList.add(
                                      `${s.zoomedSlideClass}`,
                                  )
                                : i.scale <= 1 &&
                                  g.slideEl &&
                                  g.slideEl.classList.remove(
                                      `${s.zoomedSlideClass}`,
                                  ),
                            1 === i.scale &&
                                ((g.originX = 0),
            ...
            function I(t) {
                ...
                v.isMoved ||
                    ...
                    (v.height =
                        g.imageEl.offsetHeight || g.imageEl.clientHeight),
                ...
                ((v.currentX =
                    ...
                    v.currentX < v.minX &&
                        (v.currentX =
                            v.minX + 1 - (v.minX - v.currentX + 1) ** 0.8),
                    v.currentX > v.maxX &&
                        (v.currentX =
                            v.maxX - 1 + (v.currentX - v.maxX + 1) ** 0.8),
                    v.currentY < v.minY &&
                        (v.currentY =
                            v.minY + 1 - (v.minY - v.currentY + 1) ** 0.8),
                    v.currentY > v.maxY &&
                        (v.currentY =
                            v.maxY - 1 + (v.currentY - v.maxY + 1) ** 0.8),
                    ...
                    (w.y =
                        ...
                        (Date.now() - w.prevTime) /
                        2),
                    Math.abs(v.touchesCurrent.x - w.prevPositionX) < 2 &&
                        (w.x = 0),
                    Math.abs(v.touchesCurrent.y - w.prevPositionY) < 2 &&
                        (w.y = 0),
            ...
            function z(e) {
                ...
                if (!o)
                    return (
                        ...
                        (v.startY = s.f),
                        (v.width =
                            g.imageEl.offsetWidth || g.imageEl.clientWidth),
                        (v.height =
                            g.imageEl.offsetHeight || g.imageEl.clientHeight),
                        (g.slideWidth = g.slideEl.offsetWidth),
            ...
            function $(t) {
                ...
                if (!g.slideEl) {
                    ...
                    let s =
                        g.slideEl?.querySelector(`.${i.containerClass}`) ??
                        null;
                    (s &&
                        (s =
                            s.querySelectorAll(
                        ...
                        function o(t) {
                            ...
                            ('slide' === i.by
                                ...
                                (n && 'container' !== i.by) ||
                                    ...
                                    (!Number.isNaN(a) && Number.isFinite(a)) ||
                                        (a = 1),
                                    (n =
                                        (s - e.minTranslate()) * a +
                                        t.minTranslate())),
        ...
        ({ swiper: e, extendParams: t, on: s }) => {
                ...
                if (
                    ...
                    if (
                        ...
                        (w(e.navigation.nextEl).includes(r) &&
                            ...
                            e.isEnd
                                ? o(s.lastSlideMessage)
                                : o(s.nextSlideMessage)),
                            t.includes(r) &&
                                ((e.isBeginning && !e.params.loop) ||
                                    e.slidePrev(),
                                e.isBeginning
            ...
            const x = (e, t, s) => {
                ...
                P = (t) => {
                    ...
                    i = r;
                    const o = ((e) =>
                            !!e.virtual && !!e.params.virtual?.enabled)(e),
                        d =
                            (o
                                ? parseInt(
                                      r.getAttribute(
                ...
                I = () => {
                    ...
                    if (
                        ...
                        !(function (e, t) {
                            ...
                            i,
                            e.params.autoplay && t?.enabled ? 'off' : 'polite',
                        );
                    }
                    L();
        ...
        ({ swiper: e, extendParams: t, on: s }) => {
            ...
            function o() {
                ...
                let a;
                if (t.params.loop) {
                    const e = t.clickedSlide?.getAttribute(
                        'data-swiper-slide-index',
                    );
                ...
                (e.freeMode = {
                    ...
                    onTouchMove: function () {
                        ...
                        (0 === t.velocities.length &&
                            t.velocities.push({
                                position:
                                    i[e.isHorizontal() ? 'startX' : 'startY'],
        ...
        ({ swiper: e, extendParams: t, on: s }) => {
            ...
            function a() {
                const e = r();
                return 'default' === e.mode && e.crossFade
                    ? 'cross-fade'
                    : e.mode;
            }
            ge({
        ...
        ({ swiper: e, extendParams: t, on: s }) => {
            ...
            ge({
                ...
                setTranslate: () => {
                    ...
                    c.shadow &&
                        (u
                            ? ((f = e.wrapperEl.querySelector(
                                  '.swiper-cube-shadow',
                              )),
                              f ||
                                  ((f = p('div', 'swiper-cube-shadow')),
        ...
        ({ swiper: e, extendParams: t, on: s }) => {
            ...
            ge({
                ...
                recreateShadows: () => {
                    ...
                    e.slides.forEach((e) => {
                        let s = e.progress ?? 0;
                        (t.limitRotation && (s = Math.max(Math.min(s, 1), -1)),
                            r(e, s));
                    });
                },
                ...
                setTranslate: () => {
                    ...
                    for (let s = 0; s < t.length; s += 1) {
                        ...
                        const u = i.swiperSlideOffset ?? 0,
                            m = [
                                e.params.cssMode ? -u - e.translate : -u,
                                0,
                                0,
                            ],
                            h = [0, 0, 0];
                        ...
                        if ((f && g.shadow) || !f) {
                            ...
                            if (
                                (!e && g.shadow && (e = be('creative', i)), e)
                            ) {
                                const t = n.shadowPerProgress
                                    ? c * (1 / n.limitProgress)
                                    : c;
                                e.style.opacity = String(
                                    Math.min(Math.max(Math.abs(t), 0), 1),
                                );
                            }
                        }
                        const S = ve(0, i);
            ...
            ge({
                ...
                setTranslate: () => {
                    ...
                    for (let i = 0; i < t.length; i += 1) {
                        ...
                        d.style.zIndex = String(
                            -Math.abs(Math.round(c)) + t.length,
                        );
